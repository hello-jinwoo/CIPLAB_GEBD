...
if __name__ == '__main__':
    ...
    for epoch in range(250):
        ...
        for i, (feature, event_boundaries, shot_boundaries, whole_boundaries) in enumerate(tqdm(train_dataloader)):
        ...
        if max_value > test_threshold:
            ...
            description = f'baseline_v2_s_{s}_'
            if 'all' in DATA_PATH:
                description += 'all_'
